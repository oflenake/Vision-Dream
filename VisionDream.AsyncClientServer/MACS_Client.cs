...
{
    /// <summary>
    /// Description of MACS_Client.	
    /// </summary>
    public class FrmMACS_Client : Form
	{
        #region Fields
        ...
        #region Client App Execution

  //      [STAThread]
		//public static void Main(string[] args)
		//{
		//	Application.Run(new MACS_Client());
		//}
        ...
        private void InitializeComponent() {
            ...
            this.Name = "FrmMACS_Client";
            this.Text = "MACS Client";
